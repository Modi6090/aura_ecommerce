      ...
      <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-xl space-y-8">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleLogin}>
            ...
            <div className="flex items-center justify-between">
              <div className="text-sm">
                <Link href="/auth/forgot-password" className="font-medium text-[#0F5A37] hover:underline">
                  Forgot password?
                </Link>
              </div>
            </div>
          ...
          <p className="text-center text-sm text-stone-600">
            ...
            <Link href="/auth/signup" className="font-medium text-[#0F5A37] hover:underline">
              Create account
            </Link>
          </p>
        </div>
